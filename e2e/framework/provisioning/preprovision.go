...
func (p *preProvisioner) SetupTestRun(opts SetupOptions) (*ClusterInfo, error) {
...
func (p *preProvisioner) SetupTestSuite(opts SetupOptions) (*ClusterInfo, error) {
...
func (p *preProvisioner) SetupTestCase(opts SetupOptions) (*ClusterInfo, error) {
	...
	if opts.ExpectConsul {
		...
		if err != nil && opts.ExpectConsul {
			return nil, fmt.Errorf("consul client expected but no Consul available: %v", err)
		}
...
func (p *preProvisioner) TearDownTestCase(_ string) error  { return nil }
func (p *preProvisioner) TearDownTestSuite(_ string) error { return nil }
func (p *preProvisioner) TearDownTestRun(_ string) error   { return nil }
